...
val EafitTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = Sans, fontWeight = FontWeight.Black, fontSize = 42.sp,
        lineHeight = 48.sp, letterSpacing = (-0.02).em
    ),
    ...
    headlineLarge = TextStyle(
        ...
        lineHeight = 36.sp, letterSpacing = (-0.015).em
    ),
    ...
    titleLarge = TextStyle(
        fontFamily = Sans, fontWeight = FontWeight.Bold, fontSize = 18.sp, lineHeight = 24.sp
    ),
    ...
    bodySmall = TextStyle(
        fontFamily = Sans, fontWeight = FontWeight.Normal, fontSize = 12.sp, lineHeight = 18.sp
    ),
    ...
    labelSmall = TextStyle(
        fontFamily = Sans, fontWeight = FontWeight.Medium, fontSize = 11.sp, lineHeight = 16.sp
    )
)
